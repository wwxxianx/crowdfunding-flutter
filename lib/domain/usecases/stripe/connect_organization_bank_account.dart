...
class ConnectOrganizationBankAccount
    implements UseCase<ConnectAccountResponse, NoPayload> {
  final PaymentService paymentService;

  const ConnectOrganizationBankAccount({required this.paymentService});

  @override
  Future<Either<Failure, ConnectAccountResponse>> call(
      NoPayload payload) async {
    return await paymentService.connectOrganizationStripeAccount();
  }
}
